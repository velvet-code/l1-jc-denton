...
function enqueue_scripts_styles() {
	...
	wp_enqueue_style('global-styles-css', $styles_url, array('fonts'), '20170601-2', 'screen');
	wp_enqueue_script('global-scripts-js', $scripts_url, array('jquery','fitvids','magnific-popup','sticky','scrollbar'), '20170601', true);
